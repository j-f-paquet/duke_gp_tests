...
accessFileName = "paramsSmallTest"
dataFileName = "datGeneralSmallTest"
numParams = 2
nSamplesParam1 = 4   # Discretization of each Trento parameter
nSamplesParam2 = 6   # Discretization of each Trento parameter
...
aver, aver2 = chm(param1truth, param2truth)
